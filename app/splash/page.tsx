...
export default function Splash() {
  ...
  return <main className="min-h-screen sky flex items-center justify-center relative overflow-hidden">
    <div className="z-10 text-center">
      ...
      <motion.h1 initial={{scale:.7,opacity:0}} animate={{scale:1,opacity:1}} className="pixel-text text-3xl md:text-5xl drop-shadow-[5px_5px_0_#17202a]">BATTLECRAFT</motion.h1>
